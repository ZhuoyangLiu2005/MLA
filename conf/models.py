...
@dataclass
class Prism_7B_EVE_672px(Exp_7B_One_Stage):
    model_id: str = "prism-eve-672px+7b"
    vision_backbone_id: str = "dinosiglip-vit-so-224px"
    image_resize_strategy: str = "resize-naive"
    llm_backbone_id: str = "llama2-7b-pure"
    arch_specifier: str = "no-align+fused-gelu-mlp"
...
@dataclass
class Prism_7B_A2P_Pointcloud(Exp_7B_One_Stage):
    model_id: str = "prism-a2p-pointcloud+7b"
    vision_backbone_id: str = "dinosiglip-vit-so-224px"
    image_resize_strategy: str = "resize-naive"
    llm_backbone_id: str = "llama2-7b-pure"
    arch_specifier: str = "no-align+fused-gelu-mlp"
...
class ModelRegistry(Enum):
    ...
    PRISM_EVE_672PX_7B = Prism_7B_EVE_672px
    PRISM_AP2_POINTCLOUD_7B = Prism_7B_A2P_Pointcloud
