...
class FSDPStrategy(TrainingStrategy):
    def __init__(
        ...
        self.requires_cliploss=requires_cliploss
    ...
    def run_setup(self, run_dir: Path, n_train_examples: int) -> None:
        ...
        if self.enable_mixed_precision_training and self.mixed_precision_dtype == torch.bfloat16:
            ...
            #     overwatch.info("Casting Vision Tower to *Half Precision* via `.to(dtype=...)`")
            #     self.vlm.vlm.vision_tower.to(dtype=self.vlm.vlm.vision_tower.half_precision_dtype)
