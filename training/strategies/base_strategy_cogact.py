...
from vlm.prismatic.training.metrics import Metrics, VLAMetrics
from vlm.prismatic.util import check_bloat16_supported
from vlm.prismatic.util.batching_utils import SplitModalitySampler
from vlm.prismatic.util.data_utils import PaddedCollatorForActionPrediction, PaddedCollatorForLanguageModeling
import math
            ...
            for train_idx, batch in enumerate(dataloader):
                ...
                with torch.autocast(
                    ...
                    if use_diff:
                        ...
                        metrics.commit(ar_loss=output.loss,diff_loss=diff)  
