...
OXE_DATASET_CONFIGS = {
    "rlbench": {
        "image_obs_keys": {"primary": "front_image", "next_primary": "next_front_image","secondary": None },
    ...
    "franka_dual": {
        "image_obs_keys": {"primary": "image_third", "next_primary": "next_image_third", 
                           "wrist_right": "image_wrist_right", "wrist_left": "image_wrist_left", 
                        },
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["proprio"],
