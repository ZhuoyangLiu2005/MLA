...
from models.vlm.base_vlm import VLM
...
from models.mla.fuser import get_camera_params, get_projection_func
from models.mla.generation import MultimodalGenerationManager
from models.mla.generation import images_to_patches, create_roi_mask_from_indices
from models.mla.generation import chamfer_distance_l2, earth_movers_distance
from models.mla.generation import visualize_generation_simple
...
class PrismaticVLM(VLM):
    ...
    def get_fused_tokens(
        ...
        if isinstance(images, dict):
            ...
            #     patch_indices, 
            #     valid_mask, 
            #     save_dir="/media/liuzhuoyang/new_vla/MLA_beta/MLA/vis", 
    ...
    def compute_generation_losses(
        ...
        if self.gen_tactile and next_tactile is not None and 'tactile_generation' in generation_outputs:
            ...
            tactile_loss = F.mse_loss(tactile_pred, gt_tactile) 
        ...
        if self.use_diff:
            ...
            if self.training:
                visualize_generation_simple(
                    ...
                    next_images,
                    next_point_cloud,
                    "/media/liuzhuoyang/new_vla/MLA_beta/MLA/vis/gen_vis_pretrain-0818_egg_tac"
                )
