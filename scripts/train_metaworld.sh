...
SETTING=Pretrain${PRETRAIN}_FreezeVis${FREEZE_VISON}_Window${FUTURE_ACTION_STEPS}_Diff${USE_DIFF}_Rec${USE_REC}_Contrastive${USE_CONTRASTIVE}_1024_0403_0818

TASK=metaworld_assembly_pointcloud_0814
BATCH_SIZE=8
EPOCHS=300
LEARNING_RATE=2e-5
...
NUM_GPUS=8 
NODES=1 
MASTER_ADDR="10.200.65.11" # ifconfig
NODE_RANK=0 

DATA_ROOT=/media/liuzhuoyang/data/metaworld/rlds
